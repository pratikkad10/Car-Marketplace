...
const getCarByFilter = async (req, res) => {
    const { carType, fuelType, brand, model } = req.body || {}; // Default to empty object if req.body is undefined
    ...
    try {
        ...
        console.log("Query Object:", query); // Debugging: log the query
        ...
        console.error("Error fetching cars:", error); // Debugging: log the error
        res.status(500).json({
